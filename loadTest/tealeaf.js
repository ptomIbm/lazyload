...
window.TLT = (function () {
        ...
        core = /**@lends TLT*/ {
            ...
            getSessionData: function () {
                ...
                if (!coreConfig || !coreConfig.sessionDataEnabled) {
                    utils.clog("TLT.getSessionData() API called when " + (!coreConfig ? "TLT is not initialized." : "session data sharing is disabled."));
                    return null;
                }
    ...
    _init = function (config, callback) {
        ...
        try {
            ...
            utils.clog("Call to TLFExtensionNotify failed.", e1);
        }
...
/*jshint devel:true */
    ...
    */
    ...
    function isMsgLimitReached(e) {
        ...
        if (counter) {
            ...
            if (counter.count > counter.limit) {
                ...
                utils.clog("WARNING: Message limit (" + counter.limit + ") reached for message type [" + e.type + "]");
            }
        }
    ...
    return {
        ...
        isMsgLimitReached: isMsgLimitReached,
        init: function () {
            if (!isInitialized) {
        ...
        post: function (moduleName, queueEvent, queueId) {
            if (!core.isInitialized()) {
                utils.clog("Attempt to post by '" + moduleName + "' when UIC is not initialized!");
                return;
            }
        ...
        resetFlushTimer: function (queueId) {
            queueId = queueId || defaultQueue.qid;
            if (!queueManager.exists(queueId)) {
                utils.clog("Attempt to reset timer of a queue [" + queueId + "] that does not exist!");
                return;
            }
    ...
    return {
        ...
        init: function () {
            if (!isInitialized) {
                ...
                utils.clog("Attempt to initialize service (browserService.w3c) which has been already initialized.");
            }
        },
    ...
    function initDOMDiffObserver() {
        ...
        observer = new window.MutationObserver(function (records) {
            if (records) {
                ...
                mutationDomCapture(records, triggers);
...
TLT.addModule("TLCookie", function (context) {
    ...
    return {
        ...
        createTLTSIDCookie: createTLTSIDCookie,
    ...
    TLT.init({
        ...
        services: {
            queue: {
                ...
                queues: [
                    {
                        qid: "DEFAULT",
                        endpoint: "https://prodqa-collector.tealeaf.ibmcloud.com/collector/collectorPost",
                        maxEvents: 50,
        ...
        modules: {
            ...
            TLCookie: {
                ...
                tlAppKey: "f72146b6cdcf4f8abef2fa97fc96ea12"
            }
        }
    });
}());
